...
for i1 in (Alfa2):
    for i2 in (Alfa2):
        for i3 in (Alfa2):
            ...
            print(y)
            if(y==key) :
                print('_________Sua senha foi encontrada, ou seja, se fosse um bruteforce tu taria fudido menoh KKKKKK, pato Agradesse por usar o script dele')
                exit()
